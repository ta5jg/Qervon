<!-- =============================================================================
File:           tests/end-to-end/README.md
Project:        Qervon
...
Description:
   Provides a concise orientation for the end-to-end area aligned with the Qervon source PDFs.
...
This page orients readers to the end-to-end area and keeps the repository vocabulary aligned with the source PDFs.
