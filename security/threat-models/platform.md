<!-- =============================================================================
File:           security/threat-models/platform.md
Project:        Qervon
...
Description:
   Provides a concise orientation for the threat-models area aligned with the Qervon source PDFs.
...
This page orients readers to the threat-models area and keeps the repository vocabulary aligned with the source PDFs.
