...
<!-- =============================================================================
 File:           security/policies/dependency-policy.md
 Project:        Qervon
 ...
 Description:
   Provides a concise orientation for the policies area aligned with the Qervon source PDFs.
...
This page orients readers to the policies area and keeps the repository vocabulary aligned with the source PDFs.
