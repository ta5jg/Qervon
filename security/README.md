...
<!-- =============================================================================
 ...
 Description:
   Provides a concise orientation for the security area aligned with the Qervon source PDFs.
...
This page orients readers to the security area and keeps the repository vocabulary aligned with the source PDFs.
