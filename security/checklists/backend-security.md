...
<!-- =============================================================================
 File:           security/checklists/backend-security.md
 Project:        Qervon
 ...
 Description:
   Provides a concise orientation for the checklists area aligned with the Qervon source PDFs.
...
This page orients readers to the checklists area and keeps the repository vocabulary aligned with the source PDFs.
