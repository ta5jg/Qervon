...
<!-- =============================================================================
 File:           .github/ISSUE_TEMPLATE/architecture-change.md
 Project:        Qervon
 ...
 Description:
   Provides a concise orientation for the ISSUE_TEMPLATE area aligned with the Qervon source PDFs.
...
This page orients readers to the ISSUE_TEMPLATE area and keeps the repository vocabulary aligned with the source PDFs.
