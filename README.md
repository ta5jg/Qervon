...
<!-- =============================================================================
 ...
 Description:
   Provides the canonical entry point for the Qervon platform and links the repository to the source specifications.
...
# Qervon Platform Overview

Qervon is a Logistics Operating System built for long-term modular growth.

# Purpose

This repository is organized around the two source documents in `docs/sources` and the governing specification family under `docs/`.

# Scope

- Platform vision and product positioning
- Architecture and foundation documents
- Domain, security, operations, and engineering standards
- Implementation guidance for backend, web, mobile, and data surfaces

# Key Principles

- Keep the product goal explicit and easy to understand.
- Prefer contract-first, modular, and observable design.
- Treat the backend as the source of truth.
- Use one platform vocabulary across all documents.
...
- [docs/](/Users/irfangedik/Qervon_Platform/qervon/docs)
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned platform entry point to the source PDFs. |
