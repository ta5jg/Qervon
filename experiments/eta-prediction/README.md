...
<!-- =============================================================================
 File:           experiments/eta-prediction/README.md
 Project:        Qervon
 ...
 Description:
   Provides a concise orientation for the eta-prediction area aligned with the Qervon source PDFs.
...
# Eta-prediction Overview

This page orients readers to the eta-prediction area and keeps the repository vocabulary aligned with the source PDFs.
