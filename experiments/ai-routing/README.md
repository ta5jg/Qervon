<!-- =============================================================================
File:           experiments/ai-routing/README.md
Project:        Qervon
...
Description:
   Provides a concise orientation for the ai-routing area aligned with the Qervon source PDFs.
...
This page orients readers to the ai-routing area and keeps the repository vocabulary aligned with the source PDFs.
