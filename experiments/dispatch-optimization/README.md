<!-- =============================================================================
File:           experiments/dispatch-optimization/README.md
Project:        Qervon
...
Description:
   Provides a concise orientation for the dispatch-optimization area aligned with the Qervon source PDFs.
...
# Dispatch-optimization Overview

This page orients readers to the dispatch-optimization area and keeps the repository vocabulary aligned with the source PDFs.
