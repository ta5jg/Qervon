...
<!-- =============================================================================
 ...
 Description:
   Provides a concise orientation for the web area aligned with the Qervon source PDFs.
...
This page orients readers to the web area and keeps the repository vocabulary aligned with the source PDFs.
