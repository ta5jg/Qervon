...
<!-- =============================================================================
 ...
 Description:
   Sets the expected collaboration standard for repository work.

 Specification:
   QMI-000000 and QES-000008
...
Work in this repository should remain respectful, focused, and traceable.

# Principles

- Be clear and constructive.
- Avoid unnecessary conflict and ambiguity.
- Prefer evidence, tests, and specifications over assumptions.

# References

- [qervon-2.pdf](/Users/irfangedik/Qervon_Platform/qervon/docs/sources/qervon-2.pdf)
- [docs/qes/QES-000008-code-review-standard.md](/Users/irfangedik/Qervon_Platform/qervon/docs/qes/QES-000008-code-review-standard.md)
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned collaboration guidance to the source PDFs. |
