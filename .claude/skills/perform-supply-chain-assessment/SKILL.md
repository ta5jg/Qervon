---
name: perform-supply-chain-assessment
description: Apply the Perform Supply Chain Assessment workflow for relevant perform-supply-chain-assessment work; use it before proposing or validating a change.
---
