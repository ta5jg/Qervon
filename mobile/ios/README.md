...
<!-- =============================================================================
 ...
 Description:
   Provides a concise orientation for the ios area aligned with the Qervon source PDFs.
...
This page orients readers to the ios area and keeps the repository vocabulary aligned with the source PDFs.
