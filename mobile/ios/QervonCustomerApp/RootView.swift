// =============================================================================
// File:           mobile/ios/QervonCustomerApp/RootView.swift
// Project:        Qervon
...
//
// Description:
//   Switches between the auth flow (with registration), the biometric lock
//   screen, and the main tab experience based on `AppSession.state`.
//
// License:
