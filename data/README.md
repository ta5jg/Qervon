...
<!-- =============================================================================
 ...
 Description:
   Provides a concise orientation for the data area aligned with the Qervon source PDFs.
...
This page orients readers to the data area and keeps the repository vocabulary aligned with the source PDFs.
