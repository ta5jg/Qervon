...
Description:
   Provides a concise orientation for the schemas area aligned with the Qervon source PDFs.
...
This page orients readers to the schemas area and keeps the repository vocabulary aligned with the source PDFs.
