...
<!-- =============================================================================
 ...
 Description:
   States the repository license notice and reference policy.
...
See the repository root license terms for usage and redistribution conditions.

# Notes

- This file is a notice page, not a product specification.
- If a different license is introduced, update this reference accordingly.

# References

- [README.md](/Users/irfangedik/Qervon_Platform/qervon/README.md)
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned license notice formatting. |
