...
Description:
   Provides a concise orientation for the tools area aligned with the Qervon source PDFs.
...
This page orients readers to the tools area and keeps the repository vocabulary aligned with the source PDFs.
