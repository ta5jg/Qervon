...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon architecture standard for kernel architecture.
...
This standard aligns kernel architecture with the Qervon source PDFs.

# Requirements

- Keep the kernel domain-independent.
- Use it for runtime ownership, not business logic.
- Make module registration and lifecycle deterministic.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned kernel architecture to the source PDFs. |
