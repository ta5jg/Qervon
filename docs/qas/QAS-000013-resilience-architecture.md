...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon architecture standard for resilience architecture.
...
This standard aligns resilience architecture with the Qervon source PDFs.

# Requirements

- Design for graceful degradation.
- Use retries, timeouts, and idempotency deliberately.
- Plan for partial failure as a normal state.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned resilience architecture to the source PDFs. |
