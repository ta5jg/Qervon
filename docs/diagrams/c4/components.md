...
<!-- =============================================================================
 File:           docs/diagrams/c4/components.md
 Project:        Qervon
 ...
 Description:
   Describes the components diagram and its architectural intent.
...
This diagram page explains the components view of the Qervon platform.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned the components diagram notes to the source PDFs. |
