...
<!-- =============================================================================
 File:           docs/operations/incident-runbook.md
 Project:        Qervon
 ...
 Description:
   Defines the Qervon runbook for incident runbook.
...
This runbook defines how to execute and verify incident runbook safely in the Qervon platform.

# Steps

- Triage, contain, restore, and review incidents.
- Assign an incident owner and communicate clearly.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned incident runbook to the source PDFs. |
