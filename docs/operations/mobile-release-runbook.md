...
<!-- =============================================================================
 File:           docs/operations/mobile-release-runbook.md
 Project:        Qervon
 ...
 Description:
   Defines the Qervon runbook for mobile release runbook.
...
This runbook defines how to execute and verify mobile release runbook safely in the Qervon platform.

# Steps

- Coordinate mobile build, review, and store release steps.
- Keep platform-specific approvals visible.
- Plan phased rollout and rollback paths.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned mobile release runbook to the source PDFs. |
