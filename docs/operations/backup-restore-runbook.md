...
<!-- =============================================================================
 File:           docs/operations/backup-restore-runbook.md
 Project:        Qervon
 ...
 Description:
   Defines the Qervon runbook for backup restore runbook.
...
This runbook defines how to execute and verify backup restore runbook safely in the Qervon platform.

# Steps

- Define backup scope, restore steps, and validation.
- Test recovery regularly.
- Keep restore time and data loss targets visible.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned backup restore runbook to the source PDFs. |
