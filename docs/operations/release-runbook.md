...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon runbook for release runbook.
...
This runbook defines how to execute and verify release runbook safely in the Qervon platform.

# Steps

- Coordinate release readiness and approvals.
- Track checks for code, tests, docs, and security.
- Make release rollback and communication explicit.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned release runbook to the source PDFs. |
