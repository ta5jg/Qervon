...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon engineering standard for secure coding standard.
...
This engineering standard defines how the Qervon team should implement and review secure coding standard.

# Requirements

- Validate input, escape output, and protect secrets.
- Treat authorization as a backend responsibility.
- Avoid broad exception handling and silent fallback.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned secure coding standard to the source PDFs. |
