...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon engineering standard for kotlin engineering standard.
...
This engineering standard defines how the Qervon team should implement and review kotlin engineering standard.

# Requirements

- Use Kotlin for maintainable Android delivery.
- Keep presentation and domain logic separate.
- Favor readable, immutable UI state.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned kotlin engineering standard to the source PDFs. |
