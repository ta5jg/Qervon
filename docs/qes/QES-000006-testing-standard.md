...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon engineering standard for testing standard.
...
This engineering standard defines how the Qervon team should implement and review testing standard.

# Requirements

- Require unit, integration, contract, and end-to-end coverage where needed.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned testing standard to the source PDFs. |
