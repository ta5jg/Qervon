...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon engineering standard for documentation standard.
...
This engineering standard defines how the Qervon team should implement and review documentation standard.

# Requirements

- Document public APIs and architectural decisions.
- Keep docs versioned and traceable.
- Use concise, canonical language.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned documentation standard to the source PDFs. |
