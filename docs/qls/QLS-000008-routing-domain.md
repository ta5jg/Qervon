...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon logistics domain specification for routing domain.
...
This domain specification defines routing domain within the Qervon logistics platform.

# Scope

- Optimize routes while keeping constraints visible.
- Support distance, time, and service-level trade-offs.
- Keep routing outputs explainable.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned routing domain to the source PDFs. |
