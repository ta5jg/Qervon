...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon logistics domain specification for order domain.
...
This domain specification defines order domain within the Qervon logistics platform.

# Scope

- Track order intake, lifecycle, and state transitions.
- Keep order ownership explicit.
- Separate order truth from presentation state.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned order domain to the source PDFs. |
