...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon logistics domain specification for customer domain.
...
This domain specification defines customer domain within the Qervon logistics platform.

# Scope

- Model customer profiles, addresses, and preferences.
- Keep customer-facing interactions simple and traceable.
- Support favorites, history, and feedback.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned customer domain to the source PDFs. |
