...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon logistics domain specification for logistics domain overview.
...
This domain specification defines logistics domain overview within the Qervon logistics platform.

# Scope

- Summarize the platform as a Logistics Operating System.
- Show how delivery, fleet, warehouse, and dispatch share one foundation.
- Keep the product families explicit.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned logistics domain overview to the source PDFs. |
