...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon logistics domain specification for command center.
...
This domain specification defines command center within the Qervon logistics platform.

# Scope

- Unify monitoring, control, and operator actions.
- Expose live operational state without hiding the backend truth.
- Support decision-making with clear telemetry and controls.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned command center to the source PDFs. |
