...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon logistics domain specification for service level domain.
...
This domain specification defines service level domain within the Qervon logistics platform.

# Scope

- Model SLA/SLO expectations and breaches.
- Track performance against commitments.
- Keep service-level metrics explainable.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned service level domain to the source PDFs. |
