...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon logistics domain specification for tracking domain.
...
This domain specification defines tracking domain within the Qervon logistics platform.

# Scope

- Expose shipment progress and milestones.
- Keep tracking events immutable and time ordered.
- Support live status with clear history.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned tracking domain to the source PDFs. |
