...
<!-- =============================================================================
 File:           docs/security/privacy-kvkk-gdpr.md
 Project:        Qervon
 ...
 Description:
   Defines the Qervon security guidance for privacy kvkk gdpr.
...
This document defines privacy kvkk gdpr for the Qervon platform.

# Guidance

- Classify personal data and processing purposes.
- Minimize retention and access.
- Document rights, controls, and lawful handling.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned privacy kvkk gdpr to the source PDFs. |
