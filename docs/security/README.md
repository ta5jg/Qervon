...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon security guidance for security overview.
...
This document defines security overview for the Qervon platform.

# Guidance

- Keep security explicit and auditable.
- Align controls with the source PDFs.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned security overview to the source PDFs. |
