...
<!-- =============================================================================
 File:           docs/security/secure-development-lifecycle.md
 Project:        Qervon
 ...
 Description:
   Defines the Qervon security guidance for secure development lifecycle.
...
This document defines secure development lifecycle for the Qervon platform.

# Guidance

- Shift security left into design and review.
- Require security checks before release.
- Keep secure coding standards visible to contributors.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned secure development lifecycle to the source PDFs. |
