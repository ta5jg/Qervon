<!-- =============================================================================
File:           docs/glossary/domain-language.md
Project:        Qervon
...
Description:
   Provides a concise orientation for the glossary area aligned with the Qervon source PDFs.
...
This page orients readers to the glossary area and keeps the repository vocabulary aligned with the source PDFs.
