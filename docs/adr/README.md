...
<!-- =============================================================================
 ...
 Description:
   Provides a concise overview for /Users/irfangedik/Qervon_Platform/qervon/docs/adr.
...
This page orients readers to the /Users/irfangedik/Qervon_Platform/qervon/docs/adr area and keeps the documentation aligned with the Qervon source PDFs.

# Guidance

- Explain what belongs here and what does not.
- Link to the governing architecture and standards documents.
- Keep the local guidance short and specific.
