...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon Foundation Specification for plugin system.
...
This foundation specification aligns plugin system with the Qervon source PDFs.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned plugin system to the source PDFs. |
