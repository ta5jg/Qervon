...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon Foundation Specification for integration runtime.
...
Integrations must be isolated, observable, and contract-based.

# Purpose

This specification defines how Qervon talks to external services and systems.

# Rules

- Use adapters to isolate third-party dependencies.
- Make retries, timeouts, and failure modes explicit.
- Keep integration contracts versioned and testable.

# References

- [qervon-2.pdf](/Users/irfangedik/Qervon_Platform/qervon/docs/sources/qervon-2.pdf)
- [docs/qas/QAS-000005-api-integration-standard.md](/Users/irfangedik/Qervon_Platform/qervon/docs/qas/QAS-000005-api-integration-standard.md)
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned the integration runtime specification to the source PDFs. |
