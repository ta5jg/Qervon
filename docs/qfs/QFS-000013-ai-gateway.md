...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon Foundation Specification for ai gateway.
...
AI access must stay controlled and explainable.

# Purpose

This specification defines how Qervon exposes AI capabilities without making AI the source of truth.

# Rules

- AI requests must pass through a gateway.
- AI output is advisory unless explicitly validated.
- Deterministic business logic always wins over generated output.

# References

- [qervon-2.pdf](/Users/irfangedik/Qervon_Platform/qervon/docs/sources/qervon-2.pdf)
- [docs/qas/QAS-000009-ai-architecture.md](/Users/irfangedik/Qervon_Platform/qervon/docs/qas/QAS-000009-ai-architecture.md)
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned the AI gateway specification to the source PDFs. |
