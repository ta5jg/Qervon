...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon Foundation Specification for policy engine.
...
Policies decide what is allowed and must remain auditable.

# Purpose

This specification defines how policies are expressed, evaluated, and reviewed.

# Rules

- Policies must be versioned and reviewable.
- Policy evaluation must be deterministic.
- Policy changes require clear ownership and traceability.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned the policy engine specification to the source PDFs. |
