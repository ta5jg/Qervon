...
<!-- =============================================================================
 ...
 Description:
   Defines the Qervon Foundation Specification for module system.
...
The module system is the structural backbone of the Qervon platform.

# Purpose

This specification defines how modules are declared, isolated, discovered, and composed inside the platform runtime.

# Rules

- Every feature is a module.
- Modules must expose explicit contracts instead of shared internals.
- Modules must not bypass the kernel lifecycle or dependency graph.
- Domain logic stays inside the owning module.

# Boundaries

- A module owns its behavior and state.
- Cross-module communication happens through contracts and events.
- Shared code is limited to stable foundation abstractions.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned the module system specification to the source PDFs. |
