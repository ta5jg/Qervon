...
<!-- =============================================================================
 ...
 Description:
   Defines the API guidance for deprecation policy.
...
This document defines deprecation policy for the Qervon API surface.

# Guidance

- Deprecate with notice, versioning, and migration guidance.
- Keep backward compatibility visible.
- Avoid breaking consumers without a new version.
...
|---------|------|-------------|
| 0.1.0 | 2026-08-05 | Aligned deprecation policy to the source PDFs. |
